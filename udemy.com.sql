/*
 ...
 Source Schema         : udemy.com

 Target Server Type    : MySQL
 Target Server Version : 100414
 File Encoding         : 65001

 Date: 18/01/2021 12:57:31
*/
...
-- Records of category
-- ----------------------------
INSERT INTO `category` VALUES (1, 'Web Development');
INSERT INTO `category` VALUES (2, 'Mobile App Development');
...
CREATE TABLE `course`  (
  ...
  `rating` float(255, 0) NULL DEFAULT NULL,
  `course_participant` int(255) NULL DEFAULT NULL,
  `teacher_id` int(11) NULL DEFAULT NULL,
  `last_update` datetime(0) NULL DEFAULT NULL,
  `amount_chapter` int(255) NULL DEFAULT NULL,
...
CREATE TABLE `users`  (
  ...
  `permisson` tinyint(1) NULL DEFAULT NULL,
  PRIMARY KEY (`user_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, 'longsieucapvjppro', 'chohuy', 'hoanglong090320@gmail.com', 2);
INSERT INTO `users` VALUES (2, 'huysjeucapvjppro', 'cholong', '18110123@student.hcmute.edu.vn', 1);
INSERT INTO `users` VALUES (3, 'phucpepong', 'haiconcho', 'phuctg2106@gmail.com', 2);
INSERT INTO `users` VALUES (4, 'haotrumcuoi', 'baconcho', '18110178@student.hcmute.edu.vn', 0);
INSERT INTO `users` VALUES (5, 'trancongtu', 'tutc', '18110151@student.hcmute.edu.vn', 1);
